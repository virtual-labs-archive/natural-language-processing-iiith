...
* Test Steps
  ...
  3. Don't select the root word from the dropdown list displayed on the screen and click on the 'submit' button

* Expected result
  1. Experiment page should be opened
  2. Content should be present with no distortions and Junk characters
  3. An error message should be displayed on the screen as to select the 'word' from the dropdown list displayed on the screen
