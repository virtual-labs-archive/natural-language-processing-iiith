...
class BigramTable (corpusdb.Model):
    """ database class for experiment table """
...
"""
runs one time and creates / calculates the answers for the two corpuses and stores them in the database 
"""
def create (): 
    """ stores corpus answers in database """
...
class Quiztable (db.Model):
    """database class to store the quiz questions and answers """
...
def create ():
    """ functions to create / store questions into a database """
...
def root4():
    """ sends the list of questions from database to html jinja template """
    db.create_all()
...
def checkanswers():
    """ checks the answers for the experiment table """
    userans=""
#    print("kookokokook")
...
def root8():
        """ renders corresponding html page  """
